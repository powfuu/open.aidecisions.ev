...
@Component({
  selector: 'decision-chooser-openai',
  templateUrl: './decision-chooser-openai.component.html',
  styleUrls: ['./decision-chooser-openai.component.scss'],
})
export class DecisionChooserOpenaiComponent implements OnInit {
  decisions$!: Observable<DecisionsState>;
  currentDecision: string = "";
  @Input() handleOpenModal: boolean = false;
  @ViewChild('modalOptionsOpenAi') modal!: IonModal;
  ...
  getDecisionProcess() {
    this.toastService.success("OpenAI decision choose process has been started.");
